...
// // let nwee ={...arr,[e.target.keys]: e.target.values}


// let name = document.getElementById('name').value
// let mail = document.getElementById('mail').value
// let number =document. getElementById('number').value
// let paass  =document. getElementById('pass').value

// console.log({name , mail , paass ,number});
...
function handle(e){
 fonto={...fonto, [e.target.name]: e.target.value}
 console.log(fonto);
 
}

document.querySelectorAll('input').forEach((item)=>{
  item.addEventListener('change',handle)
})
